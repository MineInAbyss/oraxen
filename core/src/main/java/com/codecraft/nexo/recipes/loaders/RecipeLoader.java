package com.codecraft.nexo.recipes.loaders;
...
public abstract class RecipeLoader {
    ...
    protected ItemStack getResult() {
        ...
        if (resultSection.isString("nexo_item"))
            result = ItemUpdater.updateItem(NexoItems.itemById(resultSection.getString("nexo_item")).build());
        else if (resultSection.isString("oraxen_item"))
            result = ItemUpdater.updateItem(NexoItems.itemById(resultSection.getString("oraxen_item")).build());
    ...
    protected ItemStack getIndredientItemStack(ConfigurationSection ingredientSection) {
        if (ingredientSection.isString("nexo_item"))
            return ItemUpdater.updateItem(NexoItems.itemById(ingredientSection.getString("nexo_item")).build());

        if (ingredientSection.isString("oraxen_item"))
            return ItemUpdater.updateItem(NexoItems.itemById(ingredientSection.getString("oraxen_item")).build());
    ...
    protected RecipeChoice getRecipeChoice(ConfigurationSection ingredientSection) {
        ...
        if (ingredientSection.isString("nexo_item"))
            return new RecipeChoice.ExactChoice(ItemUpdater.updateItem(NexoItems.itemById(ingredientSection.getString("nexo_item")).build()));

        if (ingredientSection.isString("oraxen_item"))
            return new RecipeChoice.ExactChoice(ItemUpdater.updateItem(NexoItems.itemById(ingredientSection.getString("oraxen_item")).build()));
    ...
    protected NamespacedKey getNamespacedKey() {
        return new NamespacedKey(NexoPlugin.get(), getRecipeName());
    }
