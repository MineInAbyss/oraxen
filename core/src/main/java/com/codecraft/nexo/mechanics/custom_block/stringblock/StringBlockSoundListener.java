...
public class StringBlockSoundListener implements Listener {
    ...
    public void onPistonPush(BlockPistonExtendEvent event) {
        ...
        for (Block block : tripwireList) {
            final StringBlockMechanic mechanic = NexoBlocks.getStringMechanic(block);
    ...
    public void onPlaceString(NexoStringBlockPlaceEvent event) {
    ...
    @EventHandler(priority = EventPriority.MONITOR, ignoreCancelled = true)
    public void onBreakString(NexoStringBlockBreakEvent event) {
        final StringBlockMechanic mechanic = event.getMechanic();
        if (!mechanic.hasBlockSounds()) return;
        BlockSounds blockSounds = mechanic.blockSounds();
    ...
    public void onStepFall(final GenericGameEvent event) {
        ...
        StringBlockMechanic mechanic = NexoBlocks.getStringMechanic(block);
        String sound;
        float volume;
        float pitch;
