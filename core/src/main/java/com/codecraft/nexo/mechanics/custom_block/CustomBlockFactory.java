...
public class CustomBlockFactory extends MechanicFactory {
    ...
    public CustomBlockFactory(String mechanicId) {
        ...
        MechanicsManager.registerListeners(NexoPlugin.get(), getMechanicID(), new CustomBlockListener(), new CustomBlockMiningListener());
    }
    ...
    public void soundRegistries(ResourcePack resourcePack) {
        ...
        if (NoteBlockMechanicFactory.isEnabled()) soundRegistries.addAll(List.of(BlockSounds.NEXO_WOOD_SOUND_REGISTRY, BlockSounds.VANILLA_WOOD_SOUND_REGISTRY));
        if (StringBlockMechanicFactory.isEnabled()) soundRegistries.addAll(List.of(BlockSounds.NEXO_STONE_SOUND_REGISTRY, BlockSounds.VANILLA_STONE_SOUND_REGISTRY));
