...
public class MiscListener implements Listener {
    ...
    public MiscListener(MiscMechanicFactory factory) {
        if (VersionUtil.isPaperServer()) {
            NexoPlugin.get().getServer().getPluginManager().registerEvents(new PaperOnlyListeners(factory), NexoPlugin.get());
        }
    }
    ...
    private boolean shouldPreventPiglinAggro(ItemStack itemStack) {
        MiscMechanic mechanic = MiscMechanicFactory.get().getMechanic(NexoItems.idByItem(itemStack));
