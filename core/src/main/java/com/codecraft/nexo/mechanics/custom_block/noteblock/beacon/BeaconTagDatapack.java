package com.codecraft.nexo.mechanics.custom_block.noteblock.beacon;
...
public class BeaconTagDatapack {
    ...
    private static final Key datapackKey = Key.key("minecraft:file/nexo_custom_blocks");
    private static final File customBlocksDatapack = defaultWorld.getWorldFolder().toPath().resolve("datapacks/nexo_custom_blocks").toFile();
