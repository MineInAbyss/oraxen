...
public class SaplingMechanic {
    ...
    public static final NamespacedKey SAPLING_KEY = new NamespacedKey(NexoPlugin.get(), "sapling");
    ...
    public File getSchematic() {
        File schem = new File(NexoPlugin.get().configsManager().getSchematicsFolder().getAbsolutePath() + "/" + getSchematicName());
