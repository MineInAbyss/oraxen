...
public class RegularNoteBlock {
    ...
    public RegularNoteBlock(Block block, @Nullable Player player) {
        this.container = new CustomBlockData(block, NexoPlugin.get());
        this.block = block;
        this.blockAbove = block.getRelative(BlockFace.UP);
        this.noteKey = new NamespacedKey(NexoPlugin.get(), "note");
        this.poweredKey = new NamespacedKey(NexoPlugin.get(), "powered");
        this.player = player;
        ...
        this.sound = switch (blockAbove.getType()) {
            ...
            default -> {
                ...
                NoteBlockMechanic noteBlockMechanic = NexoBlocks.getNoteBlockMechanic(blockBelow);
