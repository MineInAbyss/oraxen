package com.codecraft.nexo.mechanics.combat.spell;
...
public abstract class SpellMechanic extends Mechanic {
    ...
    public static final NamespacedKey NAMESPACED_KEY = new NamespacedKey(NexoPlugin.get(), "charges");
    ...
    protected SpellMechanic(MechanicFactory mechanicFactory, ConfigurationSection section) {
        super(mechanicFactory, section,
                ...
                item -> {
                    ...
                    return item.customTag(NAMESPACED_KEY, PersistentDataType.INTEGER, initCharges);
                },
