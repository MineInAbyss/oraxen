...
import static com.codecraft.nexo.mechanics.misc.backpack.BackpackMechanic.BACKPACK_KEY;
...
public class BackpackListener implements Listener {
    ...
    private boolean isBackpack(ItemStack item) {
        return item  != null && factory.getMechanic(NexoItems.idByItem(item)) != null;
    }

    private void openBackpack(Player player) {
        ItemStack itemInHand = player.getInventory().getItemInMainHand();
        BackpackMechanic mechanic = factory.getMechanic(NexoItems.idByItem(itemInHand));
