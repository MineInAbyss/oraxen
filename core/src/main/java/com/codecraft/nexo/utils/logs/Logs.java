package com.codecraft.nexo.utils.logs;
...
public class Logs {
    ...
    public static void logInfo(String message, boolean newline) {
        ...
        NexoPlugin.get().audience().console().sendMessage(newline ? info.append(Component.newline()) : info);
    }
    ...
    public static void logSuccess(String message, boolean newline) {
        ...
        NexoPlugin.get().audience().console().sendMessage(newline ? success.append(Component.newline()) : success);
    }
    ...
    public static void logError(String message, boolean newline) {
        ...
        NexoPlugin.get().audience().console().sendMessage(newline ? error.append(Component.newline()) : error);
    }
    ...
    public static void logWarning(String message, boolean newline) {
        ...
        NexoPlugin.get().audience().console().sendMessage(newline ? warning.append(Component.newline()) : warning);
    }

    public static void newline() {
        NexoPlugin.get().audience().console().sendMessage(Component.empty());
    }
    ...
    public static void debug(Component component) {
        if (Settings.DEBUG.toBool())
            NexoPlugin.get().audience().console().sendMessage(component != null ? component : Component.text("null"));
    }
