package com.codecraft.nexo.utils.blocksounds;
...
public class BlockSounds {
    ...
    public static String VANILLA_STONE_PLACE = "nexo:required.stone.place";
    public static String VANILLA_STONE_BREAK = "nexo:required.stone.break";
    public static String VANILLA_STONE_HIT = "nexo:required.stone.hit";
    public static String VANILLA_STONE_STEP = "nexo:required.stone.step";
    public static String VANILLA_STONE_FALL = "nexo:required.stone.fall";

    public static String VANILLA_WOOD_PLACE = "nexo:required.wood.place";
    public static String VANILLA_WOOD_BREAK = "nexo:required.wood.break";
    public static String VANILLA_WOOD_HIT = "nexo:required.wood.hit";
    public static String VANILLA_WOOD_STEP = "nexo:required.wood.step";
    public static String VANILLA_WOOD_FALL = "nexo:required.wood.fall";
    ...
    public static final SoundRegistry NEXO_STONE_SOUND_REGISTRY = SoundRegistry.soundRegistry("nexo", List.of(
    ...
    public static final SoundRegistry NEXO_WOOD_SOUND_REGISTRY = SoundRegistry.soundRegistry("nexo", List.of(
