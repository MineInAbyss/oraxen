...
public class BlockHelpers {
    ...
    public static String validateReplacedSounds(String sound) {
        ConfigurationSection mechanics = NexoPlugin.get().configsManager().getMechanics().getConfigurationSection("custom_block_sounds");
        ...
        if (sound.startsWith("block.wood") && mechanics.getBoolean("noteblock")) {
            return sound.replace("block.wood", "nexo:required.wood");
        } else if (sound.startsWith("block.stone") && mechanics.getBoolean("stringblock_and_furniture")) {
                return sound.replace("block.stone", "nexo:required.stone");
        } else return sound;
    }
    ...
    public static PersistentDataContainer getPDC(Block block) {
        return getPDC(block, NexoPlugin.get());
    }
    ...
    public static boolean isInteractable(Block placedAgainst) {
        ...
        NoteBlockMechanic noteBlockMechanic = NexoBlocks.getNoteBlockMechanic(placedAgainst);
        FurnitureMechanic furnitureMechanic = NexoFurniture.getFurnitureMechanic(placedAgainst.getLocation());
