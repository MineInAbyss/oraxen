...
public class NexoMeta {
    ...
    private boolean containsPackInfo = false;
    ...
    public void excludedFromInventory(boolean excluded) {
        this.excludedFromInventory = excluded;
    }

    public boolean excludedFromInventory() {
        return excludedFromInventory;
    }

    public void excludedFromCommands(boolean excluded) {
        this.excludedFromCommands = excluded;
    }

    public boolean excludedFromCommands() {
        return excludedFromCommands;
    }

    public void packInfo(ConfigurationSection section) {
    ...
    public boolean containsPackInfo() {
