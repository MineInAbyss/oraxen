...
public class NexoFurniturePlaceEvent extends Event implements Cancellable {
    ...
    public NexoFurniturePlaceEvent(@NotNull final FurnitureMechanic mechanic, @NotNull final Block block, @NotNull final ItemDisplay baseEntity, @NotNull final Player player, @NotNull final ItemStack itemInHand, @NotNull final EquipmentSlot hand) {
