 ...
 */
public class NexoNoteBlockDamageEvent extends NexoBlockDamageEvent implements Cancellable {
     ...
     */
    public NexoNoteBlockDamageEvent(@NotNull NoteBlockMechanic mechanic, @NotNull Block block, @NotNull Player player) {
