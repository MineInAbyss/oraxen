...
public class NexoBlockInteractEvent extends Event implements Cancellable {
    ...
    public NexoBlockInteractEvent(@NotNull final CustomBlockMechanic mechanic, @NotNull final Player player, @Nullable final ItemStack itemInHand, @NotNull final EquipmentSlot hand, @NotNull final Block block, @NotNull final BlockFace blockFace, @NotNull final Action action) {
