...
public class NexoFurnitureInteractEvent extends Event implements Cancellable {
    ...
    public NexoFurnitureInteractEvent(@NotNull final FurnitureMechanic mechanic, @NotNull final ItemDisplay baseEntity, @NotNull final Player player, @Nullable final ItemStack itemInHand, @NotNull final EquipmentSlot hand) {
        this(mechanic, baseEntity, player, itemInHand, hand, null);
    }

    public NexoFurnitureInteractEvent(@NotNull final FurnitureMechanic mechanic, @NotNull final ItemDisplay baseEntity, @NotNull final Player player, @Nullable final ItemStack itemInHand, @NotNull final EquipmentSlot hand, @Nullable Location interactionPoint) {
        this.player = player;
