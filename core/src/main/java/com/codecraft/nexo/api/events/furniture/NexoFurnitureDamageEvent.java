 ...
 */
public class NexoFurnitureDamageEvent extends Event implements Cancellable {
     ...
     */
    public NexoFurnitureDamageEvent(@NotNull final FurnitureMechanic mechanic, @NotNull final ItemDisplay baseEntity, @NotNull final Player player, @Nullable final Block block) {
    ...
    public NexoFurnitureDamageEvent(@NotNull final FurnitureMechanic mechanic, @NotNull final ItemDisplay baseEntity, @NotNull final Player player) {
