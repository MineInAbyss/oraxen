...
public enum UpdatedSettings {
    ...
    // Inventory
    NEXO_INV_LAYOUT("oraxen_inventory.menu_layout", "nexo_inventory.menu_layout"),
    NEXO_INV_ROWS("oraxen_inventory.menu_rows", "nexo_inventory.menu_rows"),
    NEXO_INV_SIZE("oraxen_inventory.menu_size", "nexo_inventory.menu_size" ),
    NEXO_INV_TITLE("oraxen_inventory.main_menu_title", "nexo_inventory.main_menu_title"),
    NEXO_INV_NEXT_ICON("oraxen_inventory.next_page_icon", "nexo_inventory.next_page_icon"),
    NEXO_INV_PREVIOUS_ICON("oraxen_inventory.previous_page_icon", "nexo_inventory.previous_page_icon"),
    NEXO_INV_EXIT("oraxen_inventory.exit_icon", "nexo_inventory.exit_icon")
    ;
